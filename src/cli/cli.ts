 ...
 * Every project gets it own copy of the env files yet the source of truth remains
 * single. Execute this script using "npx pco" command. This step should ideally be peromed 
 * in the CICD
 */
